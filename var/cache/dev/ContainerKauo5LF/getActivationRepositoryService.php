 ...
 */
class getActivationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivationRepository' shared autowired service.
     *
     * @return \App\Repository\ActivationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivationRepository.php';

        return $container->privates['App\\Repository\\ActivationRepository'] = new \App\Repository\ActivationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
