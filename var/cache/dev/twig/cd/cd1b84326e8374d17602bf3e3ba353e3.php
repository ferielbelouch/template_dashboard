...
class __TwigTemplate_799130f0c2fe58ee964d1fa612f41ab4 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"auth-main v1\">
    <div class=\"auth-wrapper\">
        ...
        yield "\" alt=\"images\" class=\"img-fluid mb-3\" />
                        <h4 class=\"f-w-500 mb-1\">Inscrivez-vous</h4>
                        <p class=\"mb-3\">Vous êtes déjà inscrit ? <a href=\"";
        // line 15
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login");
        yield "\" class=\"link-primary ms-1\">Connectez-vous !</a></p>
                    </div>
                    ";
        // line 17
        ...
        yield "
                    ...
                    <div class=\"mb-3\">
                        ";
        // line 24
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 24, $this->source); })()), "plainPassword", [], "any", false, false, false, 24), 'row');
        yield "
                    </div>
...
";
    ...
    {
        return array (  140 => 33,  131 => 27,  125 => 24,  119 => 21,  114 => 19,  109 => 17,  104 => 15,  99 => 13,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
